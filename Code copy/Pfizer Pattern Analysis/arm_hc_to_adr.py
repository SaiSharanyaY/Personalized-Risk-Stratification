...
MIN_CONFIDENCE = 0.2
MIN_LIFT = 1
OUTPUT_FOLDER = "Code/Pfizer Pattern Analysis/ARM_HC_to_ADR"
...
if __name__ == "__main__":
    ...
    run_full_pipeline("Data/Final datasets/pfizer_with_labels_dose_1+2.csv", TARGET_COLUMNS)
