...
MIN_CONFIDENCE = 0.2
MIN_LIFT = 1
OUTPUT_FOLDER = "Code/Moderna Pattern Analysis/ARM_Age_Sex_Dose_to_ADR"
...
for col in TARGET_COLUMNS:
    ...
    rules = rules[
        rules['antecedents'].apply(lambda x: any('age:' in i for i in x) and any('sex:' in i for i in x) and any('dose:' in i for i in x)) &
